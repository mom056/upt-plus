  ...
  const fingerprints = [
    {
      ...
      summary: 'Perimeter isolation, boundary defense, and least-privilege verification.',
      summaryAr: 'الدفاع عن السياج والتحقق وعزل التهديدات بمبدأ الحد الأدنى من الصلاحيات.',
    },
    {
      id: 'cloud',
      num: '02',
      ...
      summary: 'Balanced multi-node workload distribution and resilient availability.',
      summaryAr: 'توزيع متوازن لأحمال العمل وبنية حوسبية مرنة وعالية الصمود.',
    },
    {
      id: 'infrastructure',
      num: '03',
      ...
      summary: 'Structured physical transmission backbones and carrier interconnect fabrics.',
      summaryAr: 'مسارات عمود فقري فيزيائي منظم ومحولات بيانات مؤسسية عالية الاعتمادية.',
    },
  ];
    ...
    <section className="py-20 sm:py-28 bg-[#080D1A] text-slate-100 border-b border-white/5 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          {/* Right Column: Open Architectural Canvas (NO OUTER BOX / NO INNER FRAME) */}
          <div
            ...
            <div className="relative w-full h-56 flex items-center justify-center">
              ...
              {activeFingerprint === 0 && (
                <svg className="w-full h-full" viewBox="0 0 400 180" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  {/* Purple Protected Boundary with subtle V-Shield Convergence */}
                  <polygon
                    points="190,30 350,30 320,150 220,150"
                  ...
                  <line x1="190" y1="75" x2="190" y2="105" stroke="#C084FC" strokeWidth="2.5" strokeLinecap="round" />

                  {/* Incoming UPT Signal Crossing Boundary */}
                  <path d="M 20 90 L 190 90" stroke="#FF7A00" strokeWidth="2.5" strokeLinecap="round" />
                  <circle cx="190" cy="90" r="3.5" fill="#FF7A00" />
                  
                  {/* Protected Internal Flow */}
                  <path d="M 195 90 L 330 90" stroke="#FF7A00" strokeWidth="2" strokeDasharray="4 3" />
                  <circle cx="330" cy="90" r="3.5" fill="#FF7A00" />
                </svg>
              )}
              ...
              {activeFingerprint === 1 && (
                <svg className="w-full h-full" viewBox="0 0 400 180" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M 20 90 L 140 90" stroke="#FF7A00" strokeWidth="2.5" strokeLinecap="round" />
                  <circle cx="140" cy="90" r="4" fill="#FF7A00" />

                  <path d="M 140 90 L 210 40 L 340 40" stroke="#FF7A00" strokeWidth="2" />
                  <path d="M 140 90 L 210 90 L 340 90" stroke="#FF7A00" strokeWidth="2" />
                  <path d="M 140 90 L 210 140 L 340 140" stroke="#FF7A00" strokeWidth="2" />

                  <circle cx="340" cy="40" r="4" fill="#FF7A00" />
                  <circle cx="340" cy="90" r="4" fill="#FF7A00" />
                  <circle cx="340" cy="140" r="4" fill="#FF7A00" />
                </svg>
              )}
              ...
              {activeFingerprint === 2 && (
                <svg className="w-full h-full" viewBox="0 0 400 180" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <line x1="110" y1="50" x2="110" y2="130" stroke="#64748B" strokeWidth="1.5" />
                  <line x1="200" y1="50" x2="200" y2="130" stroke="#64748B" strokeWidth="1.5" />
                  <line x1="290" y1="50" x2="290" y2="130" stroke="#64748B" strokeWidth="1.5" />

                  <circle cx="110" cy="90" r="3.5" fill="#FF7A00" />
                  <circle cx="200" cy="90" r="3.5" fill="#FF7A00" />
                  <circle cx="290" cy="90" r="3.5" fill="#FF7A00" />
                </svg>
              )}
            </div>
